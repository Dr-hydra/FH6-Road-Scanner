...
Public Module ModBase
    ...
    Public Const VersionBaseName As String = "1.1.0"
    Public Const VersionCode As Integer = 2
    Public Const VersionDisplay As String = "FH6 Road Scanner 1.1.0"
    Public Const CommitHash As String = ""
    Public Const BuildTypeDisplay As String = "Release"
    ...
    Public PathImage As String = "pack://application:,,,/FH6RoadScanner;component/Images/"
    Public PathTemp As String = IO.Path.Combine(IO.Path.GetTempPath(), "FH6RoadScanner") & "\"
    Public PathAppdata As String = IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "FH6RoadScanner") & "\"
